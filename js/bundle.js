...
var NavBar = React.createClass({displayName: "NavBar",
  render: function() {
    var sections = ['home', 'about', 'more stuff'].map(function(section) {
      return ( React.createElement("li", null, " ", section, " ") )
    })
    return (
  ...
  render: function() {
    ...
    return (
      React.createElement("section", null, 
        React.createElement("h2", null, "My recipies"), 
         recipies 
      )
    )
  }
...
var RecipiesContainer = React.createClass({displayName: "RecipiesContainer",
  getInitialState: function() {
    return {
      recipies: [
  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement("h1", null, "My cooking rules"), 
        React.createElement(RecipieList, {recipies: this.state.recipies})
      )
    )
  }
})
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement(RecipiesContainer, null)
      )
    )
  }
})
